...
RULES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("maintenance", (r"صيان[هة]", r"جدول الصيان", r"مت[ىي].*(?:اغير|تغيير|استبدال|تبديل)", r"كل كم", r"service interval", r"maintenance", r"replace.*(?:filter|oil)")),
    ("safety", (r"سلام[هة]", r"احتياط", r"مقعد الطفل", r"طوارئ", r"سحب السيار", r"تعطيل.*(?:ايرباق|وساد)", r"safety", r"child seat", r"emergency", r"towing")),
    ...
    ("settings", (r"كيف (?:اغير|افعل|اضبط|اشغل|اعد)", r"اعدادات", r"بلوتوث", r"اللغه", r"الساع[هة]", r"configure", r"enable", r"change.*setting", r"pair.*bluetooth")),
